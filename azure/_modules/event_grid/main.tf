...
resource "azurerm_eventgrid_domain" "TerraFailEventGrid_domain" {
  # Drata: Configure [azurerm_eventgrid_domain.tags] to ensure that organization-wide tagging conventions are followed.
...
resource "azurerm_eventgrid_topic" "TerraFailEventGrid_topic" {
  # Drata: Configure [azurerm_eventgrid_topic.tags] to ensure that organization-wide tagging conventions are followed.
