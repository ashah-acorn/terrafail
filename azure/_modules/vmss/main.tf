...
resource "azurerm_windows_virtual_machine_scale_set" "TerraFailVMSS_windows" {
  # Drata: Default network security groups allow broader access than required. Specify [azurerm_windows_virtual_machine_scale_set.network_interface.network_security_group_id] to configure more granular access control
